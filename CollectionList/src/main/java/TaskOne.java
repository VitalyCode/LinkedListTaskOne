...
public class TaskOne {
    ...
    // Вывод команд
    public void programCommands(List linkedList) {
        int counter = -1;
        System.out.println("\r\nВыберите операцию:");
    ...
    // Добавление задач
    public void addingCases(List list, Scanner scanner) {
    ...
    // Вывод всех дел:
    public void outputOfTasks(List list) {
        System.out.println("\r\nВаш список дел:");
        int counter = 0;
    ...
    public void deletingACaseByNumber(List list) {
        if (list.isEmpty()) {
